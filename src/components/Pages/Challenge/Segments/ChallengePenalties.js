...
import { faPlus, faBars, faEllipsisV, faTimes, faGlobeEurope, faMapMarkerAlt, faImage, faCrosshairs, faQuestionCircle } from '@fortawesome/free-solid-svg-icons'
...
class ChallengePenalties extends React.Component {
    ...
    render () {
						...
						<div className="d-selected-integration">
							...
							<div className="d-integration-measurement">
								...
								<div className="d-number-points">
									<label htmlFor="">Take points every:</label>
					...
					<div className="d-action-current-step step-one-selected">
						<div className="d-action-step-items">
							...
							<div className="d-action-step-name">
								<input type="text" placeholder="Penalty Name" onChange={(e) => this.addActionParameters('title', e.target.value)} value={this.state.currentActions['title']}/>
							</div>
				...
				return (
					<div className="d-action-current-step step-two-selected">
						...
						<div className="d-action-steps-options">
							...
							<button className="d-proceed-action" onClick={() => this.toggleSaveAction()}>Save and Add Penalty</button>
						</div>
					</div>
				);
			}
        ...
        return (
          <div className="cg-input dactivity" style={ (this.props.showPenalties ? {display: 'block'} : {display: 'none'} )}>
              ...
              <div className="activity-list">
                  ...
                  <div className="activity-add-button">
                      <div className="daddactions" onClick={() => this.openAddActionModal()}>
                          ...
                          <span className="dtext">Add Penalty</span>
                      </div>
                      <ReactModal
                      ...
                      >
                          <div className="d-add-action-modal-inner d-rewards-settings-modal d-social-modal-size" style={{width: '690px'}}>
                              <h4>Penalty {(this.state.currentActions.title != "" ? '- '+this.state.currentActions.title : '')}</h4>
